...
public class KafkaProducer<K, V> implements Producer<K, V> {
     ...
     * together, typically in a consume-transform-producer pattern. Thus, the specified
    ...
    /**
     * Aborts the ongoing transaction. Any unflushed producer messages will be aborted when this call is made.
     ...
     * producer requests will fail with an {@link org.apache.kafka.common.errors.UnsupportedForMessageFormatException}
     ...
     * <p>
     * This example shows how to consume from one Kafka topic and producer to another Kafka topic:
     * <pre>
     * {@code
     ...
     * </pre>
     *
     * Note that the above example may drop records if the producer request fails. If we want to ensure that this does not occur
