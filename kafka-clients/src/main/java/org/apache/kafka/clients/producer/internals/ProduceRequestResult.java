...
/**
 * A class that models the future completion of a producer request for a single partition. There is one of these per
 * partition in a producer request and it is shared by all the {@link RecordMetadata} instances that are batched together
...
public class ProduceRequestResult {
    ...
    /**
     * Set the result of the producer request.
     *
