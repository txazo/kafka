...
public class ProduceRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<ProduceRequest> {
        ...
        public static Builder forMagic(byte magic,
            ...
            // Message format upgrades correspond with a bump in the producer request version. Older
            // message format versions are generally not supported by the producer request versions
            // following the bump.
    ...
    // This is set to null by `clearPartitionRecords` to prevent unnecessary memory retention when a producer request is
    ...
    public static void validateRecords(short version, MemoryRecords records) {
        ...
        // clients which send the wrong magic version in the wrong version of the producer request. The broker
    ...
    public static byte requiredMagicForVersion(short produceRequestVersion) {
        switch (produceRequestVersion) {
            ...
            default:
                ...
                // to update this method on a bump to the producer request version.
                throw new IllegalArgumentException("Magic value to use for producer request version " +
